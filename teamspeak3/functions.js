		...
		menufunctions: function(){
			...
			if( $body.hasClass('device-lg') || $body.hasClass('device-md') ) {
				$('#primary-menu.sub-title > ul > li').hover(function() {
					...
					$(this).prev().css({ backgroundImage : 'url("menu-divider.png"/*tpa=http://www.teamspeak3.pro/js/images/icons/menu-divider.png*/)' });
				});
			...
			if( $flickrFeedEl.length > 0 ){
				$flickrFeedEl.each(function() {
					var element = $(this),
						...
						flickrFeedTypeGet = 'http://www.teamspeak3.pro/js/photos_public.gne';

					if( flickrFeedType == 'group' ) { flickrFeedTypeGet = 'http://www.teamspeak3.pro/js/groups_pool.gne'; }
